...
const ContactMe = (props: Props) => {
  ...
  return (
    <div className="h-screen relative flex flex-col text-center mf:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center overflow-clip">
      ...
      <div className="mt-6 flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex items-center justify-center space-x-5">
            ...
            <p className="text-2xl">+123-456789</p>
          </div>
